        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FixedPricing = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    HousingUnitId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Contracts_AspNetUsers_LesseeId",
                        column: x => x.LesseeId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Contracts_Housings_HousingUnitId",
            ...
            migrationBuilder.CreateTable(
                name: "BillingContractServices",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    BillingId = table.Column<Guid>(type: "uuid", nullable: false),
                    ContractServiceId = table.Column<Guid>(type: "uuid", nullable: false),
                    Amount = table.Column<int>(type: "integer", nullable: false),
                    ServiceTotalSum = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BillingContractServices", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BillingContractServices_Billings_BillingId",
                        column: x => x.BillingId,
                        principalTable: "Billings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BillingContractServices_ContractServices_ContractServiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BillingContractServices_BillingId",
                table: "BillingContractServices",
                column: "BillingId");

            migrationBuilder.CreateIndex(
                name: "IX_BillingContractServices_ContractServiceId",
                table: "BillingContractServices",
                column: "ContractServiceId");

            migrationBuilder.CreateIndex(
                name: "IX_Billings_ContractId",
                table: "Billings",
                column: "ContractId");

            migrationBuilder.CreateIndex(
                name: "IX_Contracts_HousingUnitId",
                table: "Contracts",
