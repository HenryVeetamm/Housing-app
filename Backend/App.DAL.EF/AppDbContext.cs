...
public class AppDbContext : IdentityDbContext<AppUser, AppRole, Guid>
{
    ...
    public DbSet<Housing> Housings { get; set; } = default!;

    public DbSet<Contract> Contracts { get; set; } = default!;

    public DbSet<Billing> Billings { get; set; } = default!;

    public DbSet<ContractService> ContractServices { get; set; } = default!;

    public DbSet<BillingContractService> BillingContractServices { get; set; } = default!;
