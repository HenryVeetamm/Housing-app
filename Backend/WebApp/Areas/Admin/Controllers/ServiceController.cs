...
namespace WebApp.Areas.Admin.Controllers
{
    ...
    public class ServiceController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CostPerUnit,Title,Description,FixedPricing")] Service service)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,CostPerUnit,Title,Description,FixedPricing")] Service service)
        {
            if (id != service.Id)
            {
                return NotFound();
